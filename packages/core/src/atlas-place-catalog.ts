...
/**
 * Anagrafica persistente delle sale della provincia.
 * La presenza qui non dipende dalla programmazione del giorno.
 */
export const ATLAS_CINEMA_PLACES_VT: AtlasPlaceRegistryEntry[] = [
  {
    id: "place-cinema-olimpya-acquapendente",
    name: "Olimpya",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Acquapendente",
    address: "Via Cantorrivo, 5/a",
    screenCount: 1,
    status: "unknown",
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  {
    ...
    notes: "Censimento manuale 2026-08-16: denominazione indicata come Moderna",
  },
  {
    ...
    notes: "Fonte di programmazione MYmovies; assente dal censimento manuale del 2026-08-16",
  },
  {
  ...
  {
    id: "place-cinema-florida-civita-castellana",
    name: "Florida",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Civita Castellana",
    address: "Via del Forte, 26",
    screenCount: 1,
    status: "unknown",
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  {
    ...
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Cura di Vetralla",
    matchTowns: ["Vetralla", "Cura"],
    address: "Via Cassia, 277",
    screenCount: 1,
    status: "unknown",
    primarySourceId: "src-mymovies-vt",
  ...
  {
    id: "place-cinema-multisala-flavia-montefiascone",
    name: "Multisala Flavia",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Montefiascone",
    address: "Via della Croce, 1",
    screenCount: 2,
    status: "unknown",
    primarySourceId: "src-mymovies-vt",
    matchNames: ["Flavia", "Cinema Flavia Multisala"],
    externalRefs: {
      mymovies: {
        slug: "montefiascone",
        venue_id: "4986",
        url: "https://www.mymovies.it/cinema/viterbo/montefiascone/4986/",
      },
    },
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  {
    ...
    territoryId: "IT-VT",
    municipality: "Montefiascone",
    address: "Via Cardinal Salotti, snc",
    screenCount: 2,
    status: "unknown",
    primarySourceId: "src-mymovies-vt",
  ...
  {
    id: "place-cinema-florida-soriano-cimino",
    name: "Florida",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Soriano nel Cimino",
    address: "P.zza G. Marconi, 21",
    screenCount: 1,
    status: "unknown",
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  ...
  {
    id: "place-cinema-colombo-valentano",
    name: "Colombo",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Valentano",
    address: "Via Monte Grappa, 3",
    screenCount: 1,
    status: "unknown",
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  {
    id: "place-cinema-albertone-nazionale-vasanello",
    name: "Albertone Nazionale",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Vasanello",
    address: "Via S. Maria, 20",
    screenCount: 1,
    status: "unknown",
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  {
    id: "place-cinema-lux-viterbo",
    name: "Lux",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Viterbo",
    address: "Viale Trento, 1",
    screenCount: 1,
    status: "unknown",
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  {
    id: "place-cinema-trento-viterbo",
    name: "Trento",
    placeType: "cinema",
    territoryId: "IT-VT",
    municipality: "Viterbo",
    address: "Via del Santuario, 51",
    screenCount: 1,
    status: "unknown",
    notes: "Censimento manuale 2026-08-16: da verificare operatività",
  },
  {
    ...
    notes: "Censimento manuale 2026-08-16: denominazione indicata come Cinetuscia Village",
  },
  // Fonti di programmazione: conservate separatamente dal censimento manuale.
  {
    ...
    notes: "Cinema estivo sul lido; non presente nel censimento manuale del 2026-08-16",
  },
  {
